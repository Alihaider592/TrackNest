  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-slate-50 selection:bg-indigo-500/30 transition-colors duration-300 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        >
          <motion.div variants={fadeIn} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 backdrop-blur-md text-indigo-600 dark:text-indigo-400 text-xs font-bold mb-8 cursor-default">
            <Sparkles className="w-3.5 h-3.5" />
            <span>THE FUTURE OF CAMPUS MANAGEMENT</span>
          </motion.div>

          <motion.h1 variants={fadeIn} className="text-5xl md:text-8xl font-black tracking-tight mb-6 leading-[1.05]">
            Manage your <br />
          ...
          <motion.p variants={fadeIn} className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
      ...
      <section id="features" className="py-24 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeIn} className="md:col-span-8 group relative overflow-hidden p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] hover:shadow-2xl transition-all">
            ...
            <motion.div variants={fadeIn} className="md:col-span-4 p-10 bg-indigo-600 dark:bg-indigo-500 text-white rounded-[2.5rem] shadow-2xl shadow-indigo-500/30 flex flex-col justify-between">
              <div>
            ...
            <motion.div variants={fadeIn} className="md:col-span-4 p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] hover:border-indigo-500/50 transition-colors">
            ...
            {/* Feature 4: Long Card */}
            <motion.div variants={fadeIn} className="md:col-span-8 p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] flex flex-col md:flex-row items-center gap-10">
