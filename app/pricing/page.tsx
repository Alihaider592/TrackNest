...
const plans = [
  {
    ...
    description: "Essential tools for small teams and individual educators.",
    features: [
      "Up to 50 Students",
      "Basic Attendance",
      "Email Support",
  ...
  },
  {
    ...
    description: "Advanced features for growing institutions scaling fast.",
    features: [
      "Unlimited Students",
  ...
  },
  {
    ...
    description: "Full-scale white-label solutions for large universities.",
    features: [
      "Multi-campus Sync",
      "SSO & Custom Security",
